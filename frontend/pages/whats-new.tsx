    ...
    <PublicPage documentTitle="What's New | BirdPlan.app">
      ...
      <div className="prose prose-h2:text-foreground prose-h2:mt-12 prose-ul:list-none prose-ul:pl-4 mb-12">
        ...
        <ul>
          ...
          <li>
            ✨ A new View route button opens the day&apos;s entire route in Google Maps, using your travel mode for
            that day.
          </li>
          <li>🛠️ Distances now display in miles or kilometers based on your region.</li>
        </ul>
        <h2>August 3, 2026</h2>
        <ul>
        ...
        <h2>July 21, 2026</h2>
        <ul>
          <li>🐞 Fixed missing species and checklist counts in the hotspot dialog.</li>
        </ul>
        <h2>July 11, 2026</h2>
        <ul>
          <li>🛠️ Improved life list upload instructions and error message when the incorrect file is uploaded.</li>
        </ul>
        <h2>July 10, 2026</h2>
        <ul>
        ...
        <ul>
          ...
          <li>
            ✨ Switch between <strong>Group and Personal targets</strong> at any time to see what the whole group needs
        ...
        <ul>
          <li>
            ✨ Editors can now invite other editors or remove themselves from a trip. They cannot remove the person who
            initially created the trip.
          </li>
        </ul>
        <h2>March 14, 2025</h2>
        <ul>
        ...
        <ul>
          <li>
            ✨ Improved loading of hotspot targets from eBird. The process will now continue even if the hotspot window
            is closed.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>✨ KML Export: Added a link to Google Maps when viewing a marker in other apps such as Organic Maps.</li>
        </ul>
        <h2>March 9, 2024</h2>
        <ul>
          ...
          <li>
            ✨ Easily add a place from Google Maps such as airports, hotels, and restaurants by searching for the place.
          </li>
          <li>✨ Redesigned map interface by removing the sidebar and adding several icons to handle map functions.</li>
        </ul>
