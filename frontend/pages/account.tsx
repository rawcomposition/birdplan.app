  ...
  return (
    ...
    >
      <Tabs defaultValue="profile" orientation="vertical" className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 p-4 md:p-8 bg-card shadow-sm rounded-lg sm:min-h-[400px] mb-4">
            <TabsContent value="profile">
              <h2 className="text-xl font-medium text-foreground mb-6">Account</h2>
              <div className="flex flex-col gap-4 mb-2">
                <div className="flex items-center gap-3 px-4 py-3 bg-muted border rounded-lg w-full">
                  <Avatar user={avatarFromUser(user)} size={40} />
                  <div>
                    <p className="font-semibold">{user.name}</p>
                    {user.email && <p className="text-secondary-foreground">{user.email}</p>}
                  </div>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="email" className="max-w-md">
              <h2 className="text-xl font-medium text-foreground mb-6">Change Email</h2>
              <EmailChangeForm currentEmail={user.email || ""} />
            </TabsContent>

            <TabsContent value="delete">
              <h2 className="text-xl font-medium text-foreground mb-6">Delete Account</h2>
